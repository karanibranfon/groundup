...
urlpatterns = [
    ...
    path('about/company_info', views.company_info, name='company_info'),
    path('about/', views.company_info, name='about'),
    path('video', views.video, name='video'),
    path('terms', views.terms, name='terms'),
    path('privacy', views.privacy, name='privacy'),
    path('whats_included', views.whats_included, name='whats_included'),
    ...
    path('studies/new', views.studies_new, name='studies_new'),
    ...
    path('api/images/<str:image_id>/enhance', views.enhance_image, name='enhance_image'),
    path('api/images/<str:image_id>/measurements', views.save_measurement, name='save_measurement'),
